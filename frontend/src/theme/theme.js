...
const theme = extendTheme({
  ...
  typography: {
    fontFamily:
      '"Roboto", "SF Pro Display", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          "&:hover": {
            background:
              "linear-gradient(135deg, var(--mui-palette-primary-dark) 0%, var(--mui-palette-primary-800) 100%)",
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          ...
          boxShadow:
            "0 2px 8px 0 rgba(0, 0, 0, 0.04), 0 1px 2px 0 rgba(0, 0, 0, 0.08)",
          transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
          "&:hover": {
            transform: "translateY(-2px)",
            boxShadow:
              "0 8px 24px 0 rgba(0, 0, 0, 0.08), 0 4px 8px 0 rgba(0, 0, 0, 0.12)",

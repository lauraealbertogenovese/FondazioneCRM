...
router.post('/records', requirePermission('clinical_notes.create'), async (req, res) => {
  try {
    const {
      patient_id,
      record_type,
...
router.put('/records/:id', requirePermission('clinical_notes.update'), async (req, res) => {
  try {
    const { id } = req.params;
...
router.delete('/records/:id', requirePermission('clinical_notes.delete'), async (req, res) => {
  try {
    const { id } = req.params;
